...
class Ora():
    ...
    def query(self, sql, args={} , is_dict=True):
...
if __name__ == '__main__':
    ...
    #rows = ora.query("select *  from temp_temp a where a='zhengyangbo'")
    ...
    print
    df = ora.query_pages("select *  from temp_temp a where a=:loginname", {"loginname": "zhengyangbo"}, 1, 10)
    df = ora.query("select *  from temp_temp", is_dict=False)
    print